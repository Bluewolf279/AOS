...
public class ModItems {
	...
	public static ToolMaterial ObsidianCrystalTo = EnumHelper.addToolMaterial("Obsidian_crystalTo", 4, 2500, 12.0F, 3.6F, 18);
	...
	public static void createItem() {
		...
		GameRegistry.registerItem(Obsidian_Crystal = new BasicItem("Obsidian_Crystal"), "Obsidian_Crystal");
		GameRegistry.registerItem(Obsidian_Crystal_Clump = new BasicItem("Obsidian_Crystal_Clump"),"Obsidian_Crystal_Clump");
